...
/**
 * CÓPIA LOCAL de ArcDock@claudson/src/appActionsMenu.js.
 *
 * Local de propósito, e não um import atravessando extensões: uma extensão
 * do Shell não pode importar módulos ESM de outra pela URL de arquivo sem
 * amarrar o seu ciclo de vida ao dela — se a ArcDock for desativada ou
 * desinstalada, o import da ArcDesk quebra no meio de um clique. O preço é
 * um arquivo duplicado; o benefício é que cada extensão fica de pé sozinha.
 *
 * A regra de de-duplicação abaixo é a mesma dos dois lados. Se ela mudar
 * na ArcDock, tem que mudar aqui — é o único ponto de sincronia manual.
 */
 ...
 *   alguma coisa. Na ArcDesk a superfície não segura grab de seat como o
 *   launcher da ArcDock, mas a ordem continua importando: o menu de
 *   contexto empurrou um modal em `menu.actor`, e uma janela nova não toma
 *   o foco enquanto ele estiver de pé.
